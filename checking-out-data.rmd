...
temp_data <- temp_data[temp_data$Country != "Afghanistan, Islamic Rep. of", ]

temp_data <- temp_data[temp_data$Country != "American Samoa", ]

temp_data <- temp_data[temp_data$Country != "Antigua and Barbuda", ]

temp_data <- temp_data[temp_data$Country != "Barbados", ]

temp_data <- temp_data[temp_data$Country != "Chad", ]

temp_data <- temp_data[temp_data$Country != "Comoros, Union of the", ]

temp_data <- temp_data[temp_data$Country != "Congo, Dem. Rep. of the", ]

temp_data <- temp_data[temp_data$Country != "Cook Islands", ]

temp_data <- temp_data[temp_data$Country != "Dominica", ]

temp_data <- temp_data[temp_data$Country != "Gibraltar", ]

temp_data <- temp_data[temp_data$Country != "Grenada", ]

temp_data <- temp_data[temp_data$Country != "Guadeloupe", ]

temp_data <- temp_data[temp_data$Country != "Haiti", ]

temp_data <- temp_data[temp_data$Country != "Jamaica", ]
...
temp_data <- temp_data[temp_data$Country != "French Polynesia", ]

temp_data <- temp_data[temp_data$Country != "Martinique", ]

temp_data <- temp_data[temp_data$Country != "Malta", ]

temp_data <- temp_data[temp_data$Country != "Mauritius", ]

temp_data <- temp_data[temp_data$Country != "Monaco", ]

temp_data <- temp_data[temp_data$Country != "New Caledonia", ]

temp_data <- temp_data[temp_data$Country != "Niue", ]

temp_data <- temp_data[temp_data$Country != "Puerto Rico", ]

temp_data <- temp_data[temp_data$Country != "Réunion", ]

temp_data <- temp_data[temp_data$Country != "Samoa", ]

temp_data <- temp_data[temp_data$Country != "Seychelles", ]

temp_data <- temp_data[temp_data$Country != "Solomon Islands", ]

temp_data <- temp_data[temp_data$Country != "Somalia", ]

temp_data <- temp_data[temp_data$Country != "Sudan", ]

temp_data <- temp_data[temp_data$Country != "Tokelau", ]

temp_data <- temp_data[temp_data$Country != "Trinidad and Tobago", ]

temp_data <- temp_data[temp_data$Country != "Tuvalu", ]

temp_data <- temp_data[temp_data$Country != "Vanuatu", ]

temp_data <- temp_data[temp_data$Country != "Liechtenstein", ]
...
temp_data <- temp_data[temp_data$Country != "Cabo Verde", ]
...
temp_data$Country[temp_data$Country == "Congo, Rep. of"] <- "Republic of the Congo"
...
temp_data <- temp_data[temp_data$Country != "St. Kitts and Nevis", ]

temp_data <- temp_data[temp_data$Country != "Fiji, Rep. of", ]

temp_data <- temp_data[temp_data$Country != "Faroe Islands", ]
...
temp_data <- temp_data[temp_data$Country != "South Sudan, Rep. of", ]

temp_data <- temp_data[temp_data$Country != "St. Vincent and the Grenadines", ]
...
temp_data <- temp_data[temp_data$Country != "São Tomé and Príncipe, Dem. Rep. of", ]

temp_data <- temp_data[temp_data$Country != "St. Lucia", ]
...
temp_data <- temp_data[temp_data$Country != "Syrian Arab Rep.", ]

temp_data <- temp_data[temp_data$Country != "Yemen, Rep. of", ]
...
temp_data <- temp_data[temp_data$Country != "Marshall Islands, Rep. of the", ]

temp_data$Country[temp_data$Country == "Mauritania, Islamic Rep. of"] <- "Mauritania"

temp_data <- temp_data[temp_data$Country != "Micronesia, Federated States of", ]
...
temp_data <- temp_data[temp_data$Country != "Nauru, Rep. of", ]
...
temp_data <- temp_data[temp_data$Country != "Turks and Caicos Islands", ]

write.csv(temp_data, file = "temp_data_cleaned.csv")
