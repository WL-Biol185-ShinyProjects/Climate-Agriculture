...
#adjusting the table to delete columns 
```{r}
percent_efficiency <- read.csv("efficiency_data /only_efficiency_afgan_cambo.csv")

percent_efficiency <- subset(percent_efficiency, select = -c(1, 2, 3, 4, 5, 7, 8, 9, 11, 15, 16, 17))
